...
const defaultOperationsSettings: OperationsSettings = {
  ...
  FirstTokenErrorCorrectionEnabled: true,
  FirstTokenErrorTreatAllOutputOneEnabled: false,
  FirstTokenErrorLogEnabled: true,
  FirstTokenErrorLogMaxKeep: 5000,
  FirstTokenErrorBodyCaptureEnabled: false,
