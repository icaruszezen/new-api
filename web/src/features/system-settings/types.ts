...
export type SiteSettings = {
  ...
  'console_setting.ui_skin': string
...
export type OperationsSettings = {
  ...
  FirstTokenErrorCorrectionEnabled: boolean
  FirstTokenErrorTreatAllOutputOneEnabled: boolean
  FirstTokenErrorLogEnabled: boolean
  FirstTokenErrorLogMaxKeep: number
  FirstTokenErrorBodyCaptureEnabled: boolean
  ...
  'debug_setting.error_capture_enabled': boolean
  'debug_setting.recent_capture_enabled': boolean
}
